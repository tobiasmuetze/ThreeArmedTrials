context('Permutation test: test_RET_permutation')

test_that('Error handling',
          {
            expect_error(
              test_RET_permutation(xExp = rnorm(10),
                                   xRef = rnorm(10),
                                   xPla = rnorm(10),
                                   Delta = -1,
                                   nPermutations = 100),
            ...
            expect_error(
              test_RET_permutation(xExp = rnorm(10),
                                   ...
                                   Delta = 0.8,
                                   nPermutations = 0),
              "Number of permutations \'nPermutations\' must be a natural number."
            )
          }
) # end of test_that
